...
% Date and time: Fri, Jan 22, 2016 - 11:53:55 PM
% Requires LaTeX packages: dcolumn 
\begin{table}[ht] \centering 
  \caption{Logit models predicting references to four moral foundations using ideology (omitting leader from moral dictionary)} 
  \label{tab:m2lead} 
\tiny 
