...
\begin{frame}%[allowframbreaks]
  ...
  \begin{figure}[ht]\centering
    \visible<2>{\includegraphics[height=.9\textheight]{../calc/fig/p1_mft_ideol}}
  \end{figure}
\end{frame}
...
\begin{frame}%[allowframbreaks]
  ...
  \begin{figure}[ht]\centering
    \visible<2>{\includegraphics[height=.9\textheight]{../calc/fig/m1_mft}}
  \end{figure}
\end{frame}
...
\begin{frame}%[allowframbreaks]
  ...
  \begin{figure}[ht]\centering
    \visible<2>{\includegraphics[height=.9\textheight]{../calc/fig/m2_vote}}
  \end{figure}
\end{frame}
...
\begin{frame}%[allowframbreaks]
  ...
  \begin{figure}[ht]\centering
    \visible<2>{\includegraphics[height=.9\textheight]{../calc/fig/m3_learn}}
  \end{figure}
\end{frame}
