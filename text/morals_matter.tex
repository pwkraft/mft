...
Based on the terms signaling each foundation in the dictionary, MFT scores can be computed for any text document. Conventional dictionary-based methods consist of the proportion of signal word occurrences in each document \citep[e.g.][]{graham2009liberals}:
\begin{equation}
