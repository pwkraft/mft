...
\begin{abstract}
Moral Foundations Theory suggests that individual political attitudes and ideology are shaped and structured by fundamental moral considerations. However, recent research casts doubt on the theory's underlying tenets, such as whether moral foundations are indeed heritable and more stable than ideology. This paper further explores the notion that moral foundations in politics might not necessarily reflect an underlying stable trait but are rather context dependent. Using open-ended survey responses in the 2012 American National Election Study, I utilize a moral dictionary proposed in the literature on Moral Foundations Theory to identify references to basic moral intuitions when individuals report their attitudes towards political parties and candidates. I show that the role of moral foundations in political judgment is conditional on campaign exposure and engagement. The findings indicate that moral foundations are evoked by people to justify their political preferences and judgments in a given context and are therefore less stable than Moral Foundations Theory initially suggested.
...
% CHANGES: foundations do not predict engagement anymore, that's a cyclical argument
% NOTE: add survey mode as a control variable!
% REVISE ALL OLD ANALYSES, don't use function for data recoding, that's harder for people to understand
% maybe check regression discontinuity again?
