...
% Motivate robustness checks more!
...
Moral reasoning measured through open-ended responses is further expected to be politically consequential. The differences in the degree to which each foundation is emphasized should directly affect political preferences and vote choice consistent with the propositions of MFT.


\subsection*{Data, Variables, and Model Specification}
% DATA DESCRIPTION
% Explain data for robustness checks
...
\paragraph{Critique 3: Media exposure and political discussions do not unequivocally increase the ideological divide in moral reasoning.}

Lastly, one might argue that the somewhat inconsistent findings regarding the effects of media exposure and political discussion on the ideological might be concerned that the effects of media exposure and discussion frequency do not reveal the same patterns as political knowledge.
