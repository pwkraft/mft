...
After showing similar patterns in terms of the ideological patterns in references to moral foundations based on open-ended survey responses as in previous research relying on the MFQ (except for the dimension of authority/respect), and analyzing the extent to which the moral references (and their ideological gap) are contigent exposure to political discourse, we will now turn to the important question whether the measure of moral reasoning employed here can be shown to be relevant for different political outcomes.
