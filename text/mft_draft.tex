...
\caption{Histograms displaying the distribution of individual response lengths in number of words for each respective item category.}\label{fig:appB2num}
\end{figure}
...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{0.49\textwidth}
    ...
    \caption{Models differentiating between economic and social diemnsion of ideology. Full model results are reported in Table \ref{tab:m2soceco}.}\label{fig:appD2soceco}
  \end{subfigure}
  \begin{subfigure}[t]{0.49\textwidth}
