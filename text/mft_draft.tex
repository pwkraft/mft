...
\includegraphics{../calc/fig/p1_mft_ideol.pdf}
...
\includegraphics{../calc/fig/m1_mft.pdf}
...
\begin{figure}\centering
\includegraphics{../calc/fig/m3_learn.pdf}
...
\begin{figure}\centering
\includegraphics{../calc/fig/m3b_learn.pdf}
...
\begin{figure}[ht]\centering
\includegraphics{../calc/fig/m2b_vote.pdf}
...
\begin{figure}[ht]\centering
\includegraphics{../calc/fig/m2e_part.pdf}
...
\begin{figure}[ht]\centering
\includegraphics{../calc/fig/m2f_vote.pdf}
...
\begin{figure}[ht]\centering
\includegraphics{../calc/fig/m2_vote.pdf}
...
\input{../calc/tab/appB_mis}

\begin{figure}[ht]\centering
\includegraphics[scale=.8]{../calc/fig/appB_num.pdf}
...
\includegraphics[scale=.4]{../calc/fig/appC.pdf}
\caption{Moral foundations and ideology (party evaluations)}\label{fig:appC}
\end{figure}
...
%  \caption{Some description}
 ...
 %   \caption{Difference in predicted probabilities to reference each moral foundation between liberals and conservatives on economic and social dimension}
  \end{subfigure}%
  \begin{subfigure}[b]{3in}
    \includegraphics[scale=.4]{../calc/fig/m1_mft_noleader.pdf}
%    \caption{Difference in predicted probabilities to reference each moral foundation between liberals and conservatives (omitting leader from the dictionary)}
  \end{subfigure}
\end{figure}
