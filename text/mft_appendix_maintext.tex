...
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/app_mis}
...
\caption{Histograms of variables included in analyses.}\label{fig:app_desc}
\end{figure}
...
\caption{Histograms of variables included in replication survey.}\label{fig:app_lidesc}
\end{figure}
...
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_ideol}

\clearpage
\subsection{Moral Considerations and Vote Choice}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/logit_vote}

\clearpage
\subsection{Media Content and Exposure to Moral Rhetoric}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_media}
...
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_ideol_lisurvey}
...
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_vice}
\clearpage
\item \textit{by question type (like vs. dislike)}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_like}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_dislike}
\clearpage
\item \textit{by party/candidate (Democrat vs. Republican)}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_dem}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_rep}
\clearpage
\item \textit{by party (in- vs. out-party)}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_in}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/tobit_out}
\end{enumerate}

\clearpage
\subsubsection*{MFT and Party/Candidate Evaluations (2012 ANES)}
\input{/data/Dropbox/Uni/Projects/2014/mft/calc/tab/ols_feel}